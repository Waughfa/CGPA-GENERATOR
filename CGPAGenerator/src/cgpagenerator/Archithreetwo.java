...
public class Archithreetwo extends javax.swing.JFrame {
    ...
    String str1;
    Connection con = null;
    double arrcredit[] = new double[7];
    double arrgrade[] = new double[7];

    public Archithreetwo() {
        try {
            initComponents();
    ...
    public Archithreetwo(String ID) {
        try {
            initComponents();
            str1 = ID;
            con = DriverManager.getConnection("jdbc:derby://localhost:1527/Student", "WAUGHFA", "WAUGHFA");
    ...
    private void initComponents() {
        ...
        jTextField11.setText("Working Drawing-I");
        jTextField11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField11ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 298, 230, 40));
        ...
        getContentPane().add(jTextFieldeeelabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 472, 83, 40));

        jTextField2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField2.setText("Mechanical Equipment");
        jTextField2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField2ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 240, 230, 40));

        jTextField12.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField12.setText("Physical Planning-III");
        jTextField12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField12ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 414, 230, 40));
        ...
        getContentPane().add(jTextFieldsdgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 124, 83, 40));
        ...
        getContentPane().add(jTextFieldeeecredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 414, 83, 40));

        jTextField3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField3.setText("Structure and Architecture-IV");
        jTextField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField3ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 356, 230, 40));
        ...
        getContentPane().add(jTextFielddsgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 182, 83, 40));
        ...
        getContentPane().add(jTextFielddldgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 298, 83, 40));

        jTextField4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField4.setText("Specifications & Cost Estimating");
        jTextField4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField4ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 472, -1, 40));
        ...
        getContentPane().add(jTextFielddslabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 240, 83, 40));
        ...
        getContentPane().add(jLabelcredits, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 83, 62, 23));
        ...
        getContentPane().add(jTextFieldsdcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 124, 83, 40));
        ...
        getContentPane().add(jTextFielddscredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 182, 83, 40));
        ...
        getContentPane().add(jTextFieldeeelabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 472, 83, 40));
        ...
        getContentPane().add(jTextFielddldcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 298, 83, 40));
        ...
        getContentPane().add(jTextFielddslabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 83, 40));
        ...
        getContentPane().add(jLabelgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 83, 62, 23));
        ...
        getContentPane().add(jTextFielddldlabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 356, 83, 40));
        ...
        getContentPane().add(jLabelsubjects, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 83, 62, 23));
        ...
        getContentPane().add(jTextFielddldlabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 356, 83, 40));

        jTextField1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField1.setText("History of Architecture-IV");
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 124, 230, 40));
        ...
        getContentPane().add(jTextFieldeeegrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 414, 83, 40));

        jTextField10.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField10.setText("Design Studio-VI");
        jTextField10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField10ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 182, 230, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(849, 551, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArchithreetwoHub obj = new ArchithreetwoHub(str1);
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archithreetwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Archithreetwo().setVisible(true);
            }
        });
    }
