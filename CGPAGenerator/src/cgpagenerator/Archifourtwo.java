...
public class Archifourtwo extends javax.swing.JFrame {
    ...
    String str1;
    Connection con = null;
    double arrcredit[] = new double[6];
    double arrgrade[] = new double[6];
    ...
    private void initComponents() {
        ...
        jTextField11.setText("Urban Infrastructure Planning");
        jTextField11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField11ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 326, 240, 40));

        jTextField2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField2.setText("Interior Design Studio");
        jTextField2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField2ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 268, 240, 40));

        jTextField12.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField12.setText("Real Estate Finance & Investment");
        jTextField12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField12ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 442, -1, 40));
        ...
        getContentPane().add(jTextFieldsdgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 152, 83, 40));
        ...
        getContentPane().add(jTextFieldeeecredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 442, 83, 40));

        jTextField3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField3.setText("Structure and Architecture-VI");
        jTextField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField3ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 384, 240, 40));
        ...
        getContentPane().add(jTextFielddsgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 210, 83, 40));
        ...
        getContentPane().add(jTextFielddldgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 326, 83, 40));
        ...
        getContentPane().add(jTextFielddslabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 268, 83, 40));
        ...
        getContentPane().add(jLabelcredits, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 111, 62, 23));
        ...
        jTextFieldsdcredit.setText("9.0");
        jTextFieldsdcredit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldsdcreditActionPerformed(evt);
            }
        });
        getContentPane().add(jTextFieldsdcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 152, 83, 40));
        ...
        getContentPane().add(jTextFielddscredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 210, 83, 40));
        ...
        getContentPane().add(jTextFielddldcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 326, 83, 40));
        ...
        getContentPane().add(jTextFielddslabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 268, 83, 40));
        ...
        getContentPane().add(jLabelgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 111, 62, 23));
        ...
        getContentPane().add(jTextFielddldlabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 384, 83, 40));
        ...
        getContentPane().add(jLabelsubjects, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 111, 62, 23));
        ...
        getContentPane().add(jTextFielddldlabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 384, 83, 40));

        jTextField1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField1.setText("Design Studio-VIII");
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 152, 240, 40));
        ...
        getContentPane().add(jTextFieldeeegrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 442, 83, 40));

        jTextField10.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField10.setText("Project Economics");
        jTextField10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField10ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 210, 240, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArchifourtwoHub obj = new ArchifourtwoHub(str1);
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archifourtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Archifourtwo().setVisible(true);
            }
        });
    }
