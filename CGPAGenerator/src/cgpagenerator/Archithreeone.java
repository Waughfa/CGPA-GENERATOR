...
public class Archithreeone extends javax.swing.JFrame {
    ...
    String str1;
    Connection con = null;
    double arrcredit[] = new double[8];
    double arrgrade[] = new double[8];

    public Archithreeone() {
        try {
            initComponents();
    ...
    public Archithreeone(String ID) {
        try {
            initComponents();
            str1 = ID;
            con = DriverManager.getConnection("jdbc:derby://localhost:1527/Student", "WAUGHFA", "WAUGHFA");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldhumgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 492, 83, 40));

        jTextField11.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField11.setText("Electrical Equipment");
        jTextField11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField11ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 260, 208, 40));
        ...
        getContentPane().add(jTextFieldeeelabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 434, 83, 40));

        jTextField2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField2.setText("Design Studio-V");
        jTextField2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField2ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 202, 208, 40));

        jTextField12.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField12.setText("Structure and Architecture-III");
        ...
        getContentPane().add(jTextFieldsdgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 86, 83, 40));

        jTextFieldeeecredit.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jTextFieldeeecredit.setText("2.0");
        jTextFieldeeecredit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldeeecreditActionPerformed(evt);
            }
        });
        getContentPane().add(jTextFieldeeecredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 376, 83, 40));

        jTextField3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField3.setText("Field Study-II");
        jTextField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField3ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 318, 208, 40));
        ...
        getContentPane().add(jTextFielddsgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 144, 83, 40));
        ...
        getContentPane().add(jTextFieldhumcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 492, 83, 40));

        jTextField13.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField13.setText("Survey Practical");
        jTextField13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField13ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 492, 208, 40));
        ...
        getContentPane().add(jTextFielddldgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 260, 83, 40));

        jTextField4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField4.setText("Survey Techniques");
        jTextField4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField4ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 434, 208, 40));
        ...
        getContentPane().add(jTextFielddslabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 202, 83, 40));
        ...
        getContentPane().add(jLabelcredits, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 45, 62, 23));
        ...
        getContentPane().add(jTextFieldsdcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 86, 83, 40));
        ...
        getContentPane().add(jLabelgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 45, 62, 23));
        ...
        getContentPane().add(jTextFielddldlabcredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 318, 83, 40));
        ...
        getContentPane().add(jTextFielddldlabgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 318, 83, 40));

        jTextField1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField1.setText("History of Architecture-III");
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 86, 208, 40));
        ...
        getContentPane().add(jTextFieldeeegrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 376, 83, 40));

        jTextField10.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jTextField10.setText("Theory of Design-III");
        jTextField10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField10ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 144, 208, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArchithreeoneHub obj = new ArchithreeoneHub(str1);
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Archithreeone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Archithreeone().setVisible(true);
            }
        });
    }
